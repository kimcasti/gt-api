...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Project management content type';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    completedTasks: Schema.Attribute.Integer &
    ...
    teamMembers: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    totalTasks: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Task management content type';
    displayName: 'Task';
    pluralName: 'tasks';
    singularName: 'task';
  };
  ...
  attributes: {
    assignedToInitials: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 10;
      }>;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Por hacer'>;
